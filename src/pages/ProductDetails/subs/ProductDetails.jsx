  ...
  return (
    <>
      {productReducer.productDetails.map((product) => {
        return (
          <VStack mt={2} p={4} alignItems="left" width={{ base: '100%', md: '80%', lg: '70%' }}>
            <Box
              as="button"
              variant="link"
            ...
            <Text fontFamily="sans-serif" fontSize={{ base: '1.5em', md: '2em' }}>
              {product.item_name}
            </Text>
            <Rating rating={data.rating} numReviews={data.numReviews} />
            <HStack>
              <Text
                _hover={{ cursor: "pointer", color: "#077ACC", textDecoration: "underline" }}
                onClick={() => history.push(`/seller/${product.item_seller.id}/profile`)}
                fontFamily="sans-serif"
                color="#555"
                fontSize="12px"
              >
              ...
              <Text
                _hover={{ cursor: "pointer", color: "#077ACC" }}
                onClick={() => history.push(`/sellers/${product.item_seller.id}/${product.item_seller.business_name}`)}
                fontFamily="sans-serif"
                color="#555"
                fontSize="12px"
              >
            ...
            <VStack alignItems="flex-start" spacing="10px">
              ...
              <Stat>
                <StatLabel fontFamily="sans-serif" fontSize="13px" textTransform="uppercase" color="#555">
                  Size
                </StatLabel>
              </Stat>
            ...
            <HStack mb={10} mt={10} spacing={4} width="100%">
              <Button
                fontFamily="sans-serif"
                borderRadius="50px"
                textColor="white"
            ...
            <Box borderColor="#f3f3f3" borderWidth="1px" mt={10} borderRadius="10px" width="100%">
